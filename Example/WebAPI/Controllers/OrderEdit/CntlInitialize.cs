...
namespace WebAPI.Controllers.OrderEdit
{
  public partial class OrderEditController
  {
    ...
    public virtual IActionResult Initialize([FromBody]InitializeRequest request)
    {
      ...
      {
        return Json(new InitializeResponse(InitializeResponse.Results.NG, Statics.ErrorMessageUpdate, null));
      }
      ...
      if (!request.Validate())
      {
        ...
        return Json(new InitializeResponse(InitializeResponse.Results.NG, Statics.ErrorMessageRequired, null));
      }
